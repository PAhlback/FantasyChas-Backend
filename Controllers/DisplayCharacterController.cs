...
namespace FantasyChas_Backend.Controllers
{
    ...
    public class DisplayCharacterController : ControllerBase
    {
        ...
        public DisplayCharacterController(ILogger<DisplayCharacterController> logger)//IdentityUser user
        {
            _logger = logger;
            //_user = user;
        }
        ...
        public IActionResult GetAllCharacters(IdentityUser user)// ta in aktiv user och välj characters för den
        {
